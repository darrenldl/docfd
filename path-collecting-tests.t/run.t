Default path is not picked if any of the following is used: --paths-from, --glob, --single-line-glob:
  ...
  File: './test0/abcd.md'
  File: './test0/abcd.txt'
  File: './test0/abcd/defg.md'
  File: './test0/abcd/defg.txt'
  File: './test1/7890.md'
  File: './test1/efgh.md'
  File: './test1/efgh.txt'
  File: './test1/efgh/hijk.md'
  File: './test1/efgh/hijk.txt'
  $ docfd --debug-log - --index-only --glob '*.log' . 2>&1 | grep '^File:' | sort
  File: './empty-paths.txt'
  File: './test.log'
  File: './test.md'
...
--single-line-glob takes precedence over --glob and --exts:
  ...
  Using multiline search mode for document './test0/1234.md'
  Using multiline search mode for document './test0/abcd.md'
  Using multiline search mode for document './test0/abcd/defg.md'
  Using multiline search mode for document './test1/7890.md'
  Using multiline search mode for document './test1/efgh.md'
  Using multiline search mode for document './test1/efgh/hijk.md'
  Using multiline search mode for document '$TESTCASE_ROOT/empty-paths.txt'
  Using multiline search mode for document '$TESTCASE_ROOT/test.txt'
...
--single-line-exts takes precedence over --glob and --exts:
  ...
  Using single line search mode for document './test0/abcd.txt'
  Using single line search mode for document './test0/abcd/defg.txt'
  Using single line search mode for document './test1/efgh.txt'
  Using single line search mode for document './test1/efgh/hijk.txt'
  Using single line search mode for document '$TESTCASE_ROOT/empty-paths.txt'
  Using single line search mode for document '$TESTCASE_ROOT/test.txt'
  ...
  Using single line search mode for document './test0/1234.md'
  Using single line search mode for document './test0/abcd.md'
  Using single line search mode for document './test0/abcd/defg.md'
  Using single line search mode for document './test1/7890.md'
  Using single line search mode for document './test1/efgh.md'
  Using single line search mode for document './test1/efgh/hijk.md'
...
--exts apply to directories in FILE in --paths-from FILE:
  ...
  Using multiline search mode for document 'test0/abcd.txt'
  Using multiline search mode for document 'test0/abcd/defg.txt'
  Using multiline search mode for document 'test1/efgh/hijk.txt'
